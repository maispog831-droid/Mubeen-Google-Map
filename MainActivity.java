...
public class MainActivity extends Activity implements OnMapReadyCallback {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                if (googleMap != null) {
                    ...
                    catch (SecurityException e) { Toast.makeText(MainActivity.this, "Location permission unavailable", Toast.LENGTH_SHORT).show(); }
                }
            }
        });
        hideSystemUi();
    ...
    @Override public void onMapReady(GoogleMap map) {
        ...
        googleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(30.3753, 69.3451), 5.5f));
    }
